...
public class CreateCardProduct extends javax.swing.JPanel {
    ...
    public static JPanel createProductPanel(DefaultTableModel tableModel, JPanel productPanel, String product_name, float priceS, float priceL, String image) {
        CreateCardProduct cardProductPanel = new CreateCardProduct();
    ...
    private static void updateRowNumbers(DefaultTableModel tableModel) {
        for (int i = 0; i < tableModel.getRowCount(); i++) {
