...
public class test extends javax.swing.JPanel {
    ...
    private CategoryDaoMenu categoryDao;
    ...
    public test() {
        initComponents();
        categoryDao = new CategoryDaoMenu(); // Instantiate DAO
        loadCategoryButtons();
    }

    private void loadCategoryButtons() {
        List<CategoryMenu> categories = categoryDao.getAllCategories();
        
        for (CategoryMenu category : categories) {
            System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
            JButton categoryButton = new JButton(category.getCategoryName());
            categoryButton.setBackground(new java.awt.Color(102, 102, 102));
            categoryButton.setFont(new java.awt.Font("Segoe UI", 1, 12));
            categoryButton.setForeground(new java.awt.Color(255, 255, 255));
            categoryButton.addActionListener((ActionEvent evt) -> {
                categoryButtonActionPerformed(evt, category); // Handle button click
            });
            jPanel6.add(categoryButton); // Add button to jPanel6
        }
    ...
    private void initComponents() {
        ...
        add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 800, 80));
    ...
    private void SoftDrintButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }                                               

    private void TeaButtonActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         
    ...
    private void categoryButtonActionPerformed(ActionEvent evt, CategoryMenu category) {
        // Implement action when a category button is clicked
        // Example: Update UI based on selected category
